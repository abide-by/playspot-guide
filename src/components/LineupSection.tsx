...
const specs = [
  {
    label: "제품 크기",
    auto: "330×472×550 mm",
    manual: "320×435×1770 mm (3단기준)",
  },
  { label: "무게", auto: "약 17kg", manual: "약 21kg" },
  {
    label: "가격",
    auto: "900,000원 (VAT 별도)",
    manual: "2단 300,000원 / 3단 455,000원 (VAT 별도)",
  },
  { label: "1PY당 예상 투자", auto: "약 800~900만원", manual: "약 400만원" },
  { label: "캡슐 규격", auto: "45mm ~ 최대 92mm", manual: "45mm ~ 최대 75mm" },
  {
    label: "결제 방식",
    auto: "카드, 카카오페이, 토스페이, 네이버페이, 애플페이",
    manual: "전용 코인 (개당 1,000원 교환)",
  },
  {
    label: "원격 제어",
    auto: "가능 (결제 취소, 토출 등)",
            ...
            >
              <div className="flex items-start gap-3 mb-5">
                ...
                <div className="min-w-0 text-left">
                  ...
                  <p className="text-xs text-primary/75 mt-2 font-medium">
                    클릭하면 현장 사진 3장을 볼 수 있어요
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start gap-3 mb-5">
                ...
                <div className="min-w-0 text-left">
                  ...
                  <p className="text-xs text-sky-800/80 mt-2 font-medium">
                    클릭하면 현장 사진 3장을 볼 수 있어요
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
            ...
            <div className="glass-card p-6 flex flex-col h-full md:min-h-[11rem]">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed flex-1">
                다양한 간편 결제를 지원하고, 결제·매출 내역이 실시간으로 맞춰져
                별도 대조 없이 운영하기 편합니다. 앱 매출은 참고용으로 보시고,
                정확한 정산은 카드사·nibs 등에서 확인하시는 것을 권장합니다.
              </p>
            </div>
            <div className="glass-card p-6 flex flex-col h-full md:min-h-[11rem]">
              <h4 className="text-base font-bold text-sky-900 mb-2">
                수동 운영 가이드
              </h4>
              <p className="text-sm text-muted-foreground leading-relaxed flex-1">
                원활한 운영을 위해{" "}
                <strong className="text-foreground">전용 코인</strong> 사용을
                권장합니다. 상황에 따라 코인이 혼용될 수 있으니 비치·회수 시
                유의해 주세요. 구조가 단순해 현장에서 바로 점검·안내하기
                좋습니다.
              </p>
            </div>
          </div>
                    ...
                    {slides.map((_, i) => (
                      <button
                        ...
                        className={cn(
                          ...
                          i === slideIdx
                            ? "bg-white shadow-[0_0_0_2px_hsl(var(--primary))]"
