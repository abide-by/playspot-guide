...
const deviceFAQ: FAQItem[] = [
  {
    ...
    a: (
      <>
        <p className="mb-3">
          구동 방식에 따라 디지털(자동)과 아날로그(수동)으로 구분됩니다.
        </p>
        <ul className="space-y-1.5 text-muted-foreground">
          <li>
            • <strong className="text-foreground">플레이 큐브</strong> (자동):
            카드 및 간편결제 기반 운영
          </li>
          <li>
            • <strong className="text-foreground">플레이 수동 머신</strong>{" "}
            (수동): 전용 코인(동전) 또는 카드(교환기 연동 시) 사용
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    a: (
      <ul className="space-y-1.5 text-muted-foreground">
        <li>
          • <strong className="text-foreground">플레이 큐브</strong>: 원격 제어
          가능, 무인 운영 최적화. 초기 비용 2~3배 높음
        </li>
        <li>
          • <strong className="text-foreground">플레이 수동 머신</strong>: 초기
          비용 저렴, 진입 장벽 낮음. 문제 발생 시 현장 방문 필요
        </li>
      </ul>
    ),
  },
  {
    ...
    a: (
      <ul className="space-y-1.5 text-muted-foreground">
        <li>
          • <strong className="text-foreground">자동 머신</strong>: 최소 45mm ~
          최대 92mm
        </li>
        <li>
          • <strong className="text-foreground">수동 머신</strong>: 최소 45mm ~
          최대 75mm
        </li>
      </ul>
    ),
...
const paymentFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    a: (
      <p className="text-muted-foreground">
        당사는 기기 직판 본사로, 별도 매출 수수료 없음. 운영 수익은 100% 점주
        귀속입니다.
      </p>
    ),
  },
      ...
      <>
        <ul className="space-y-1.5 text-muted-foreground mb-3">
          <li>
            • 원격 제어:{" "}
            <a
              href="https://cube.playspot.co.kr/"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="guide-note mt-2 leading-relaxed">
          플레이스팟 앱의 매출은{" "}
          <strong className="text-foreground">참고용</strong>으로 보시는 것을
          권장드리며, 자세한 내역은{" "}
          <strong className="text-foreground">nibs</strong>에서 확인하시는 것을
          추천드립니다.
        </div>
      </>
    ),
    ...
    a: (
      <>
        ...
        <div className="guide-note mt-3 leading-relaxed">
          머신의 현장 결제나 기본 운영에는 어떠한 영향이나 불이익도 발생하지
          않습니다.
        </div>
      </>
    ),
...
const scheduleFAQ: FAQItem[] = [
  {
    ...
    a: (
      <p className="text-muted-foreground">
        결제 완료일을 기준으로 최소 7일에서 최대 15일 정도 소요됩니다. 단, 현장
        스케줄 및 카드 가맹점 심사 상황에 따라 실제 일정은 다소 변동될 수
        있습니다.
      </p>
    ),
  },
  {
    ...
    a: (
      <ul className="space-y-1.5 text-muted-foreground">
        <li>
          • <strong className="text-foreground">자동 머신</strong>: Wi-Fi 필수,
          1대당 0.33A 전력 확보 필요
        </li>
        <li>
          • <strong className="text-foreground">수동 머신</strong>: 코인 교환기
          사용 시 콘센트·Wi-Fi 필요
        </li>
      </ul>
    ),
    ...
    a: (
      <>
        <p className="text-muted-foreground mb-2">
          단말기 사업자 세팅 변경 시{" "}
          <strong className="text-foreground">건당 15,000원 (VAT 별도)</strong>
          의 비용이 발생합니다.
        </p>
        <div className="guide-note mt-3 leading-relaxed">
          ※ A/S 출장비는 별도로 산정됩니다.
  ...
  },
  {
    ...
    a: (
      <p className="text-muted-foreground">
        전문 인력 방문 설치 시 현장 상황 확인 후 설치 비용이 별도 산정됩니다.
        직접 수령 또는 화물 배송 시 세팅비 또는 화물 배송비만 청구됩니다.
      </p>
    ),
  },
]
...
const asFAQ: FAQItem[] = [
  {
    ...
    a: (
      <>
        <ul className="space-y-1.5 text-muted-foreground mb-3">
          <li>
            • <strong className="text-foreground">기기 신규 구매 시</strong>:
            납품 완료일로부터 1년
          </li>
          <li>
  ...
  },
  {
    ...
    a: (
      <p className="text-muted-foreground">
        전용 도매몰 <strong className="text-foreground">플레이캡슐토이</strong>
        에서 구매 가능합니다.
        <br />
        <a
          href="https://playcapsuletoy.com/"
          target="_blank"
          rel="noreferrer"
          className="text-primary hover:underline text-base break-all"
        >
          https://playcapsuletoy.com
        </a>
      </p>
    ),
  },
      ...
      <>
        <p className="text-muted-foreground">
          ...
          <strong className="text-foreground">
            단기(30일 이내) 팝업스토어·행사·이벤트 임대 렌탈
          </strong>
          만 지원합니다.
        </p>
        <div className="guide-note mt-3 leading-relaxed">
          ※ <strong className="text-primary">한 달 이상</strong> 이용하신다면,{" "}
          <strong className="text-primary">구매가 훨씬 저렴</strong>합니다.
        </div>
      </>
    ),
  },
  {
    ...
    a: (
      <p className="text-muted-foreground">
        야외 설치는 가능하나, 기기 결함 방지를 위해 눈이나 비를 직접 맞지 않도록
        반드시 <strong className="text-foreground">가림막(어닝 등)</strong>이
        설치된 환경에 배치해 주셔야 합니다.
      </p>
    ),
  },
          ...
          >
            <AccordionTrigger className="text-left text-base md:text-lg font-semibold text-foreground hover:no-underline py-6 [&[data-state=open]]:pb-3">
              <span className="flex items-start gap-3">
                <span className="text-sm font-bold text-primary tabular-nums shrink-0 mt-0.5">
                  {item.num}
                </span>
