...
const powerSpecs = [
  {
    ...
    text: (
      <>
        머신 1대당 <strong className="text-foreground">평균 0.15A</strong>, 최대
        0.33A 소모
      </>
    ),
  },
  { icon: Zap, text: <>설치 대수 × 0.33A 이상의 설비 용량 확보 필수</> },
  {
    ...
    text: (
      <>
        전압 안정을 위해{" "}
        <strong className="text-foreground">단독 회로 구성</strong> 권장
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <strong className="text-foreground">30A 차단기</strong> 설치 권장
      </>
    ),
  },
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <FadeInUp>
        <div className="glass-card p-6 mb-4 pink-glow">
          ...
          <p className="text-base text-muted-foreground mb-3 leading-relaxed">
            무상 지원 기간 종료 이후에는 유료 서비스로 전환되지만, 서비스 연장을
            원치 않으실 경우 원격 관리 앱 사용만 제한될 뿐입니다.{" "}
